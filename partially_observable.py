...
def rewardFunction(soldier, oldEnemyHealth, oldSoldierHealth, currentAction, currentState):
    ...
    if(stateSpace[currentState] == "combat 75+"):
        ...
        detectionArea = pygame.sprite.spritecollide(soldier, blue_soldier_list, False,
                                                    pygame.sprite.collide_circle_ratio(1.4))
        pygame.draw.circle(screen, WHITE, (soldier.getPosition()[0] + int(soldier.r * 2), soldier.getPosition()[1] +
        ...
        if(detectionArea):
            ...
            for red_soldier in red_soldier_list:
                otherDetectionArea = pygame.sprite.spritecollide(red_soldier, blue_soldier_list, False,
                                                                 pygame.sprite.collide_circle_ratio(1.4))
